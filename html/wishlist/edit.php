...
<div id="content">
  ...
  <a class="back-link" href="<?php echo url_for('/wishlist/index.php?id=' . $id); ?>">&laquo; Back to List</a>
  ...
  <div class="user edit">
    ...
    <form action="<?php echo url_for('/wishlist/edit.php?id=' . h(u($id)) . '&item=' . h(u($item_id))); ?>" method="post">
